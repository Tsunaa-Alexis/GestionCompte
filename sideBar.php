<div class="sidebar d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
    ...
    <hr>
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="./?action=categorie" class="nav-link text-white">
                <svg class="bi me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
                Categories
                </a>
            </li>
            <li>
                <a href="./?action=depenses" class="nav-link text-white">
                <svg class="bi me-2" width="16" height="16"><use xlink:href="#speedometer2"></use></svg>
                Dépenses
                </a>
            </li>
    ...
    <?php if(!isset($_SESSION['login'])){ ?>
        <div class="dropdown">
            <ul class="navbar-nav mr-right">
                <li class="nav-item">
                    <a class="nav-link btn " href="./?action=inscription">S'inscrire</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn"   href="./?action=login">S'identifier</a>
                </li>
            </ul>
        </div>
    <?php } ?>
