                    ...
                    <div class="sectionHeader" style="width:100%; height:40px;">
                        <div style="width:100%; height:40px;">
                            <div class="sectionTitle" style="float:left; padding-top:5px; font-size:25px;"><strong>Liste des Dépenses</strong></div>
                                <div class="sectionAddAction" style="float:left; padding-left:20px;"><button type="button" onclick="msgBoxAddDepense();" class="btn btn-info btn-sm" title="Ajouter une dépense"><i class="fas fa-plus"></i> Dépense</button></div>
                        </div>
                    </div>
