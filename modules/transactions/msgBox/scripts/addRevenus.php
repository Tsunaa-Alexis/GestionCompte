...
$transaction = new Transaction(['prix' => $_POST['prix'], 'commentaire' => $_POST['commentaire'], 'type' => '2', 'categorie' => $categorie, 'dateAjout' => strtotime($_POST['date']), 'user' => $categorie->getUser()]); 
